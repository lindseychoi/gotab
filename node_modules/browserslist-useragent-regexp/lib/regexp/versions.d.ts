import { IRangedSemver, ISemverCompareOptions } from '../semver';
import { IRangedBrowsers } from '../browsers';
import { IBrowserVersionRegExp, IBrowserVersionedRegExp } from '../useragent';
/**
 ...
 */
export declare function applyVersionsToRegExp(regExp: string | RegExp, versions: IRangedSemver[], options: ISemverCompareOptions): string;
/**
 ...
 */
export declare function applyVersionsToRegExps(browserVersionRegExps: IBrowserVersionRegExp[], browsers: IRangedBrowsers, options: ISemverCompareOptions): IBrowserVersionedRegExp[];
