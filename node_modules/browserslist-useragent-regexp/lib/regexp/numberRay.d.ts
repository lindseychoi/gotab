 ...
 */
export declare function rayRangeDigitPattern(digit: number, includes: boolean): string;
/**
 ...
 */
export declare function optimizeRaysNumberPatterns(raysNumberPatterns: string[][]): string[][];
/**
 * Create numeric ray pattern.
 * @param from - Start from this number.
 * @returns Numeric ray pattern parts.
 */
export declare function rayToNumberPatterns(from: number): string[];
//# sourceMappingURL=numberRay.d.ts.map