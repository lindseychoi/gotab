 ...
 */
export declare function normalizeBrowserFamily(query: string): string;
/**
 * Compare two arrays.
 ...
 */
export declare function compareArrays(a: unknown[], b: unknown[], from?: number): boolean;
/**
 * Array of numbers to array of first and last elements.
 * @param numbers - Array of numbers.
 * @returns Number or two numbers.
 */
export declare function numbersToRanges(numbers: number | number[]): number | number[];
