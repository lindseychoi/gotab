import { IBrowser, IBrowsersListRequest } from './types';
/**
 * Browsers strings to info objects.
 * @param browsersList - Browsers strings with family and version.
 * @returns Browser info objects.
 */
export declare function parseBrowsersList(browsersList: string[]): IBrowser[];
/**
 * Request browsers list.
 * @param options - Options to get browsers list.
 * @returns Browser info objects.
 */
export declare function getBrowsersList(options?: IBrowsersListRequest): IBrowser[];
